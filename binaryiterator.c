...
btree_node* node_create(btree_node* parent, int d)
{
...
void preorderNonRecursive(btree_node* root) {
...
int main()
{
	...
	preorderNonRecursive(myBtree->root);
